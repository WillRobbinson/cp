...
project.addParameter('arm.MattTrait');
project.addParameter("--macro keep('arm.MattTrait')");
...
project.addParameter('arm.node.GreenNodeTree');
project.addParameter("--macro keep('arm.node.GreenNodeTree')");
